...
export const confirmEmail = asyncHandler(async (req, res, next) => {
    ...
    if (user.matchedCount) {
        ...
        // return res.status(200).redirect(`${process.env.FE_URL}/#/notFound`)
        // return res.status(200).render('notRegisterAccount', { message: "Email not exist" })
        return res.status(200).send('<p>No register account with this email address</p>')
